    ...
    public static class ServerFragment extends BaseGuidedStepFragment {
        ...
        public void onGuidedActionClicked(GuidedAction action) {
            if (action.getId() == ACTION_ID_NEXT) {
                ...
                // HTTP Port Field
                GuidedAction httpPortAction = findActionById(ACTION_ID_PORT);
                CharSequence httpPortValue = httpPortAction.getDescription();

                if (httpPortValue == null || TextUtils.isEmpty(httpPortValue)) {
                    Toast.makeText(getActivity(), R.string.server_port_invalid, Toast.LENGTH_SHORT).show();
                    return;
                }

                args.putString(Constants.KEY_PORT, httpPortAction.getDescription().toString());
    ...
    public static class ValidateHTTPAccountFragment extends BaseGuidedStepFragment {
        ...
        public void onStart() {
            ...
            try {
                ...
                userdata.putString(Constants.KEY_PORT, mAccountHttpPort);
                ...
                Log.e(TAG, "Failed to connect to HTTP server", e);

                args.putString(Constants.KEY_ERROR_MESSAGE, getString(R.string.setup_http_failed));
