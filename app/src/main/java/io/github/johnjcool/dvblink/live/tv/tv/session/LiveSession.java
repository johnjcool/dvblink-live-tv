...
public class LiveSession extends BaseTvInputService.Session {
    ...
    public LiveSession(Context context, String inputId) {
    ...
    public View onCreateOverlayView() {
        ...
        try {
            ...
            if (isWeb) {
                WebPlayer wv = new WebPlayer(mContext.getApplicationContext(),
                ...
                Glide.with(mContext.getApplicationContext()).load(mCurrentProgram.getPosterArtUri()).into(iv);
                return iv;
            } else {
                if (DEBUG) {
                ...
                if (mCurrentChannel.getChannelLogo() != null && !mCurrentChannel.getChannelLogo().isEmpty()) {
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                bitmap[0] = Glide.with(mContext.getApplicationContext()).asBitmap()
    ...
    private boolean play(InternalProviderData internalProviderData) {
        ...
        if (internalProviderData.getVideoUrl() == null) {
            Toast.makeText(mContext, mContext.getString(R.string.msg_no_url_found), Toast.LENGTH_SHORT).show();
